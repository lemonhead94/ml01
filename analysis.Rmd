...
1.  Linear Models, Lead: Levin Reichmuth
2.  Extending the Linear Model: Non-linearity (GAM), Lead: Levin Reichmuth
3.  Extending the Linear Model: Generalised Linear Models (GLM), Lead: Jorit Studer
5.  Neural Networks, Lead: Taejun Moon
6.  SVM, Lead: Taejun Moon
...
emp_attrition_train_lm <- emp_attrition_train[,c("Attrition", "Age", "BusinessTravel",
                                        "DistanceFromHome", "EnvironmentSatisfaction",
                                        "JobSatisfaction",
                                        "NumCompaniesWorked", "OverTime",
                                        "WorkLifeBalance", "YearsAtCompany",
                                        "YearsSinceLastPromotion",
                                        "YearsWithCurrManager")]
emp_attrition_test_lm <- emp_attrition_test[,c("Attrition", "Age", "BusinessTravel",
                                        "DistanceFromHome", "EnvironmentSatisfaction",
                                        "JobSatisfaction",
                                        "NumCompaniesWorked", "OverTime",
                                        "WorkLifeBalance", "YearsAtCompany",
...
```{r LM without log, include=TRUE, results=FALSE}
...
In the next step the independent variables (Age, YearsAtCompany, YearsWithCurrentManager) which displayed right skeewedness are log transformed for
...
```{r Log Linear Regression, include=TRUE, results=FALSE}
...
```{r, echo=FALSE, fig.show="hold", out.width="100%",out.height="50%"}
# Variable importance plot
...
```{r, echo=FALSE, out.width="100%", fig.show='hold', message=FALSE, warning=FALSE, results='hide'}
set.seed(111)

par(pty = "s")
roc(emp_attrition_test$Attrition, as.numeric(test_pred_radial)-1, legacy.axes=TRUE, plot=TRUE, percent=TRUE, print.auc=TRUE, col="blue", xlab="False Positive Percentage", ylab="True Positive Percentage")
plot.roc(emp_attrition_test$Attrition, as.numeric(test_pred_linear)-1, percent=TRUE, col="#4daf4a", add=TRUE, print.auc=TRUE, print.auc.y=43)
plot.roc(emp_attrition_test.under$Attrition, as.numeric(test_pred_radial.under)-1, percent=TRUE, col="#e34a33", add=TRUE, print.auc=TRUE, print.auc.y=36.5)
plot.roc(emp_attrition_test.under$Attrition, as.numeric(test_pred_linear.under)-1, percent=TRUE, col="#1c9099", add=TRUE, print.auc=TRUE, print.auc.y=30)
legend("bottomright", legend=c(
  "Radial SVM all data set",
  "Linear SVM all data set",
  "Radial SVM under sampled",
  "Linear SVM under sampled"
  ), col = c("blue", "#4daf4a", "#e34a33", "#1c9099"), lwd=2, cex = 0.75)
title("SVM Model with All Predictors", outer=TRUE)
```
...
(EnvironmentSatisfaction, NumCompaniesWorked, JobSatisfaction, BusinessTravel, DistanceFromHome, OverTime, YearsAtCompany, PercentSalaryHike, WorkLifeBalance, Age, YearsWithCurrManager, YearsSinceLastPromotion)
...
```{r, echo=FALSE, out.width="100%", fig.show='hold', warning=FALSE, message=FALSE}
set.seed(111)
par(pty = "s")
roc(emp_attrition_test.under$Attrition, as.numeric(test_pred_radial.2)-1, legacy.axes=TRUE, plot=TRUE, percent=TRUE, print.auc=TRUE, col="blue", xlab="False Positive Percentage", ylab="True Positive Percentage")
plot.roc(emp_attrition_test.under$Attrition, as.numeric(test_pred_linear.2)-1, percent=TRUE, col="#4daf4a", add=TRUE, print.auc=TRUE, print.auc.y=43)
legend("bottomright", legend=c(
  "Radial SVM under sampled",
  "Linear SVM under sampled"
  ), col = c("blue", "#4daf4a", "#e34a33", "#1c9099"), lwd=2, cex = 0.75)
title("SVM Model with selected Predictors", outer=TRUE)
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, results='hide', out.width="100%", fig.show='hold'}
par(pty = "s")
roc(emp_attrition_test$Attrition, cv_glm.probability, plot=TRUE, legacy.axes=TRUE, percent=TRUE, xlab="False Positive Percentage", ylab="True Positive Percentage", col="blue", print.auc=TRUE)
plot.roc(emp_attrition_test$Attrition, cv_glm.probability.2, percent=TRUE, col="#e34a33", add=TRUE, print.auc=TRUE, print.auc.y=43)
plot.roc(emp_attrition_test.under$Attrition, as.numeric(test_pred_linear.2)-1, percent=TRUE, col="#4daf4a", add=TRUE, print.auc=TRUE, print.auc.y=36.5)
plot.roc(emp_attrition_test$Attrition, cv_nn.probability, percent=TRUE, col="#1c9099", add=TRUE, print.auc=TRUE, print.auc.y=30)
legend("bottomright", legend=c(
  "Logistic Regression with All Predictors",
  "Logistic Regression with selected Predictors",
  "Linear SVM under sampled with selected Predictors",
  "Neural Network with all Predictors"
  ), col = c("blue", "#4daf4a", "#e34a33", "#1c9099"), lwd=2, cex = 0.75)
title("SVM Model with selected Predictors", outer=TRUE)
```
