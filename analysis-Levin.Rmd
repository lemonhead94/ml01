...
# Age
names(emp_attrition)[names(emp_attrition) == "ï..Age"] <- "Age"
...
# Na's / -Inf values # back to 0 
sum(is.na(emp_attrition_log)) # 0
sum(emp_attrition_log == "-Inf") #1521
...
- For next model only general variables, with p-value > 0.05 are kept
- Adjusted R-squared:  0.7861 without log transformation / with log transformation 0.4208 
